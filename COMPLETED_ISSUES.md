...
This file contains security issues and improvements that have been successfully implemented in the bskyoauth library. These items have been moved from [TODO.md](TODO.md) to reduce noise and keep the active TODO list focused on pending work.

All completed issues are documented in [CHANGELOG.md](CHANGELOG.md) with version numbers and implementation details.
...
*For details on implementation and version numbers, see [CHANGELOG.md](CHANGELOG.md).*
